...
/** ============================================================================
 *   @n@b read_data_from_file_crc_workaround
 *
 *   @b Description
 *   @n Utility function to read data from a given file and do bit reverse.
 *
 *   @param[in]
 *   @n fp                  File handle from which data needs to be read from.
 *
 ...
 * =============================================================================
 */
Void read_data_from_file_crc_workaround (FILE* fp, UInt8* pDataBuffer)
{
	Int32   temp = 0;
